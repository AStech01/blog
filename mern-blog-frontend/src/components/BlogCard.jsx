...
//   return (
//     <motion.div
//       className="bg-white rounded-xl shadow-md hover:shadow-2xl overflow-hidden transition transform hover:-translate-y-1"
...
//       <motion.div
//         className="bg-white rounded-xl shadow-md hover:shadow-2xl overflow-hidden cursor-pointer transition transform hover:-translate-y-1"
